      ...
      <div className="retro-card max-w-md w-full text-center !bg-storm-dark relative">
        ...
        <div className="space-y-4 mb-8">
          {CREDITS.map((item) => {
            ...
            return (
              <div key={item.role} className="flex items-center gap-3 justify-center">
                ...
                <div>
                  ...
                  <p className="font-body text-sm text-white text-left">{item.name}</p>
                </div>
              </div>
            );
          })}
        ...
        <div className="border-t-3 border-black/30 pt-4 mb-6">
          ...
          <p className="font-body text-xs text-storm-light mt-1 flex items-center justify-center gap-1">
            Built with <Heart size={12} className="text-warning-red" /> for science education
          </p>
        </div>
      </div>
    </div>

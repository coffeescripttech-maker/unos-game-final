...
export default function HUDHealth() {
  ...
  return (
    <div className="hud-health absolute top-[110px] left-1/2 -translate-x-1/2 z-30 flex gap-5 retro-card !p-3 !bg-storm-dark/80 shadow-lg shadow-black/20 pointer-events-none">
      {bars.map(bar => {
